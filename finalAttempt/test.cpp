...
int main(){
    ...
    /*21*/int group1[40] = {3,9,10,14,17,18,20,22,23,25,29,33,35,41,47,51,58,59,60,61,62,66,67,69,73,75,76,77,78,81,85,88,90,91,92,93,94,98,99,100};
    /*15*/int group2[40] = {1,4,8,11,13,16,24,28,30,31,32,34,36,37,38,40,42,46,48,50,52,53,54,55,56,63,64,70,71,72,74,79,82,83,84,87,95,96,97,101};
    int orphans[21] = {21,15,2,5,6,7,12,19,26,27,39,43,44,45,49,57,65,68,80,86,89};
    int solution[102] = {0};
    for(int i=0;i<40;i++){
        solution[group1[i]] = 1;
        solution[group2[i]] = 0;
